...
import OnboardingCheckout from "./pages/public/OnboardingCheckout";
...
function App() {
  ...
  return (
    <Routes>
      {/* Landing (public) — has sticky glossy transparent navbar + full responsive layout */}
      <Route path="/" element={<Landing />} />
      <Route path="/contact" element={<Contact />} />
      <Route path="/onboarding" element={<Onboarding />} />
      <Route path="/onboarding/checkout" element={<OnboardingCheckout />} />
