        ...
        <div className='p-3 border-b border-[var(--border)]'>
          <div className='relative'>
            ...
            <input
              ...
              className='w-full pl-9 pr-3 py-2 text-sm rounded-lg bg-[var(--background)] border border-[var(--border)] text-[var(--foreground)] placeholder:text-[var(--muted-foreground)] focus:outline-none focus:ring-1 focus:ring-[var(--primary)]'
            />
          </div>
        </div>
