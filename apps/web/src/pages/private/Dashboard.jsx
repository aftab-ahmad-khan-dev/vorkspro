...
function Dashboard() {
  ...
  return (
    <div className='min-h-screen w-full pb-8 flex flex-col gap-y-8'>
      ...
      {hasPermission("Projects") && (
        <div
          id='driver-dashboard-project-status'
          className='group relative rounded-2xl p-6 overflow-hidden border border-[var(--border)] bg-[var(--card)]/80 backdrop-blur-sm mb-8 transition-all duration-300 hover:shadow-xl hover:shadow-[var(--primary)]/5 hover:border-[var(--primary)]/30 before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-br before:from-[var(--primary)]/5 before:to-transparent before:opacity-0 hover:before:opacity-100 before:transition-opacity before:pointer-events-none'
        >
              ...
              <div className='space-y-4'>
                {recentLeaveRequests.map((req) => {
                  ...
                  return (
                    <div
                      key={req._id}
                      className='flex items-start gap-3 p-3 rounded-xl hover:bg-[var(--muted)]/30 transition-colors -mx-1'
                    >
      ...
      {quickActions.length > 0 && (
        <div
          id='driver-dashboard-quick-actions'
