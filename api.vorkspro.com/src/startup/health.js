...
const liveHealthHTMLPath = path.join(__dirname, '../templates/livehealth.html');
const testHealthHTMLPath = path.join(__dirname, '../templates/testhealth.html');
...
function getHealthPage(req, res) {
  try {
    ...
    let currentHtmlPath = mode === 'production' ? liveHealthHTMLPath :
